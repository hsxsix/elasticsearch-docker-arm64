...
RUN cd /opt && curl --retry 8 -s -L -O https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.5.1-linux-x86_64.tar.gz -# && cd -
...
RUN tar zxf /opt/elasticsearch-7.5.1-linux-x86_64.tar.gz --strip-components=1
